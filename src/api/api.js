...
export default {
  ...
  // 分类管理相关接口
  categoryCreate: '/miniBOM/category/create',        // 新增分类
  categoryList: '/miniBOM/category/list',            // 查询分类列表
  categoryUpdate: '/miniBOM/category/update',        // 修改分类
  categoryDelete: '/miniBOM/category/delete',        // 删除分类（需要拼接 code）

  // BOM管理相关接口
  bomCreate: '/miniBOM/BOM/create',                    // 创建 BOMLink
  bomCreateWithPart: '/miniBOM/BOM/createPart',        // 创建 BOMLink 并创建子 Part
